...
let favoriteThings = {
  ...
  food: 'burritos',
  person: 'that one guy',
  book: 'Desert Solitiare',
  movie: 'They Live',
  holiday: 'Thanks Giving'
}

/*
  After you've made your object, use bracket or dot notation to add another key named 'car' with 
  the value being your favorite car and then another key named 'show' with the value being your 
  favorite show.
*/

//Code here
favoriteThings.car = 'gen 1 tacoma';
...
console.log(ingredients(foodTypes));
...
let kitty = new Cat('timber',3,'black');
...
let mage = new Wizard('bob', 99, 'donut')
...
/*
    ...
    sell should be a function that changes the value of sold to true and prints the string: '{brand}
     {model} has been sold.'
...
//Code Here
let phone1 = new Phone('Apple','I-phone-Z', 2, 'Pink', 10000);
let phone2 = new Phone('Google','Pixel-infinite', 100, 'Purple', 700);
let phone3 = new Phone('Samsung','notepad', 50, 'Black', 1500);
/* 
...
//Code Here
//The second spread operator overwrites the first, so the information in the second object will be displayed.
...
//Code Here
let myFirstVehicle = new Vehicle(5,'silver',185000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1,'purple',12345,'honda',true);
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcycle.move(12345);
...
//Code Here
let myFirstBoat = new Boat(8,'red',5000,'Big Black Canyon', 'Wake Boat', false);
/*
  Call the checkSeaworthiness method on your new boat
*/

//Code Here
myFirstBoat.checkSeaworthyiness();
/*
